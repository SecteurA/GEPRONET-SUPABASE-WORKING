...
import { RefreshCw, Search, ChevronLeft, ChevronRight, Plus, Eye, Edit, FileText, Truck } from 'lucide-react';
...
const InvoiceListPage: React.FC<InvoiceListPageProps> = ({ onCreateNew, onViewInvoice, onGenerateDeliveryNote }) => {
